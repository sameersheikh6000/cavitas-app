    ...
    <section className="faqTab">
      ...
      <div style={{ textAlign: "justify", width: "100%" }}>
        <p>
          ...
          <p>
            {" "}
            {t("PrivacyPolicy.Para_No_7")} 

          </p>
          <br />             {t("PrivacyPolicy.Para_No_8")} 
{" "}
          <br />             {t("PrivacyPolicy.Para_No_9")} 
          ...
          <span style={{ fontWeight: "bold" }}>{t("PrivacyPolicy.s1")}</span>           {t("PrivacyPolicy.Para_No_17")} 
