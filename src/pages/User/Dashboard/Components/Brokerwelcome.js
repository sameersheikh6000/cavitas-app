  ...
  return (
    <section className="dashboard__container__content__welcomePage">
      ...
      <p className="dashboard__container__content__welcomePage__description">
        {t("Pannel_Dashboard_Dashboard.Heading_Part1")}
        <br />
        {t("Pannel_Dashboard_Dashboard_Broker.Heading_Part2")}
        <br />
        {t("Pannel_Dashboard_Dashboard_Broker.Heading_Part3")}
        <br />
        {t("Pannel_Dashboard_Dashboard_Broker.Heading_Part4")} 
        <br />
        {t("Pannel_Dashboard_Dashboard_Broker.Heading_Part7")} 
        <br />
        {t("Pannel_Dashboard_Dashboard.Heading_Part5")}
        <br />
