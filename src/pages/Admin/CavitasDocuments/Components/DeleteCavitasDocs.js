...
function DeleteCavitasDocs({cavitasDocs_id, setSuccessMessage, setErrorMessage, fetchCavitasDocs}) {
    const {deleteCavitasDocs} = useCavitasDocs();
...
export default DeleteCavitasDocs
