          ...
          {user?.data?.role ? (
            <div className="sidebar__linkButtons">
              ...
              {user?.data?.role === "broker" && (
                <>
                  <Link
                    to={`/insuredclient/view/${lang === "pl" ? "pl" : "en"}`}
                    className="sidebar__linkButtons__link"
                  >
              ...
              <Link
                to={`/profile/user/view/${lang === "pl" ? "pl" : "en"}`}
                className="sidebar__linkButtons__link"
              >
              ...
              <div className="sidebar__linkButtons__buttons">
                {user?.data?.role === "broker" && (
                  <Button
                    onClick={() =>
                      navigate(`/uploadclient/${lang === "pl" ? lang : "en"}`)
                    }
                  >
                    <p>{t("Pannel_Dashboard.Uploadclient")}</p>{" "}
                  </Button>
                )}
                {user?.data?.role === "employ" && (
                  ...
                  >
                    {t("Pannel_Dashboard.Uploadnewperson")}
                  </Button>
                )}
